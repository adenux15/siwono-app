...
async def run_test():
    ...
    try:
        ...
        # -> Fill Email with 'admin@siwono.local' and Password with 'password123', then click the 'Masuk ke Sistem' button.
        ...
        # -> Click the 'Peminjaman' link in the left menu to open the loans page.
        # Peminjaman link
        elem = page.get_by_role('link', name='Peminjaman', exact=True)
        await elem.click(timeout=10000)
        
        # -> Click the 'Proses Pengembalian' button on the first loan card (Warkah No. 1234/2026) to start the return process and verify a success message or a return form appears.
