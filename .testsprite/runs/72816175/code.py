...
async def run_test():
    ...
    try:
        ...
        # -> Fill the 'Email' field with 'admin@siwono.local' and the 'Password' field with 'password123', then click the 'Masuk ke Sistem' button.
        ...
        # -> Click the 'Dashboard' menu item in the left navigation to reload the dashboard, then check for the 'Dasbor Monitor' heading.
        # Dashboard link
