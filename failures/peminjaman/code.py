...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Masuk ke Sistem' button after filling the Email and Password fields to sign in.
        ...
        # -> Fill the 'Nomor Warkah', 'Nama Peminjam', and 'Keperluan / Catatan' fields, then click the 'Simpan Peminjaman' button.
        ...
        await elem.wait_for(state="visible", timeout=10000)
        await elem.fill("Keperluan: penelitian arsip untuk validasi data.")
